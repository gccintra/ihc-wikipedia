...
(function () {
  ...
  function applyPrefs() {
    ...
    body.classList.toggle('reading-wide', pref('width') === 'wide');
    applyScale();
    syncButtons();
  }
  function syncButtons() {
    ...
    var w = document.querySelector('.reader-tools [data-act="width"]');
    if (w) w.classList.toggle('on', body.classList.contains('reading-wide'));
  ...
  if (tools) {
    tools.addEventListener('click', function (e) {
      ...
      else if (act === 'width') { var w = !body.classList.contains('reading-wide'); body.classList.toggle('reading-wide', w); pref('width', w ? 'wide' : 'normal'); }
